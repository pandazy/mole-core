...
describe('string.replaceAll', () => {
  it('should replace a string with specified target and replacement', () => {
    expect.assertions(6);
    expect(replaceAll('%grr%')('88')('foo-bar|%grr%|%grr%')).toBe('foo-bar|88|88');
    expect(replaceAll('%grr%')('99')('')).toBe('');
    expect(replaceAll('%grr%')('88')('%grr%|barfoo|%grr%')).toBe('88|barfoo|88');
    expect(replaceAll('%grr%')('88')('foobar|%grr%%grr%|foobar')).toBe('foobar|8888|foobar');
    expect(replaceAll('%grr%')('88')('%grr%%grr%|foobar')).toBe('8888|foobar');
